...
- Github [Discussions](https://github.com/cardano-foundation/cf-metadata-core/discussions)
...
We host our documentation / user manual in the [Wiki](https://github.com/cardano-foundation/cf-metadata-core/wiki) and [README](./README.md).

### Bug reports

[Submit an issue](https://github.com/cardano-foundation/cf-metadata-core/issues/new).
...
We use the [Ideas discussions category](https://github.com/cardano-foundation/cf-metadata-core/discussions/categories/ideas) to discuss and vote on feature ideas, but you can also [submit an issue](https://github.com/cardano-foundation/cf-metadata-core/issues/new) using the "Feature idea :thought_balloon:" template and we convert that to a discussion.
